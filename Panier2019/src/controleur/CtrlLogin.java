...
import service.ServiceFiltres;
import service.User;
import xmodel.Utilisateur;
...
//ici bruno			
			req.getSession().setAttribute("user", new User(cl.getUser(), cl.getPass()));
...
//ici bruno			
			...
			req.getSession().setAttribute("tabfiltres", ServiceFiltres.getFiltres() );
